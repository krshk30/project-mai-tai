...
**Deployment status:** deployed and verified. GitHub `main`, VPS `/home/trader/project-mai-tai`, and the hotfix worktree are on `c08d5be`. Only `project-mai-tai-strategy.service` was restarted; post-restart logs showed fresh snapshot batches through `2026-06-11 10:55:33 UTC` and Redis `strategy-state` had a fresh non-empty watchlist.
