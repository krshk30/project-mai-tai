...
> Dated history entries for 2026-05 (newest first). Active doc: [`../session-handoff.md`](../session-handoff.md). Other archives: [2026-04](2026-04.md) · [2026-06](2026-06.md).

v2 build-out — bar-build, ATR-flip design, exit-engine groundwork, regression battles.
