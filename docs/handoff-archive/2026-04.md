...
> Dated history entries for 2026-04 (newest first). Active doc: [`../session-handoff.md`](../session-handoff.md). Other archives: [2026-05](2026-05.md) · [2026-06](2026-06.md).

Earliest history — token-SPOF saga, early v2 scaffolding, streamer fixes.
