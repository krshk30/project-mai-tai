...
1. Entry checks hard gates such as trading hours, cooldown, existing position, and optional EMA gate.
   The default MACD-family trading window is 7:00 AM to 6:00 PM ET, and the dead zone is currently disabled.
